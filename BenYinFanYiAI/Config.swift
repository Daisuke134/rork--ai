...
enum Config {
    static let APPLE_API_ISSUER_ID = ""
    static let APPLE_API_KEY_ID = ""
    static let EXPO_PUBLIC_PROJECT_ID = ""
    static let EXPO_PUBLIC_REVENUECAT_IOS_API_KEY = "appl_JnhLlSmfcOuBeKxFPYtfzETngXE"
    static let EXPO_PUBLIC_REVENUECAT_TEST_API_KEY = "appl_JnhLlSmfcOuBeKxFPYtfzETngXE"
