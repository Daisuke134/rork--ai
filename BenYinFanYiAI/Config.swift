...
enum Config {
    ...
    static let EXPO_PUBLIC_REVENUECAT_IOS_API_KEY = "sk_JvKJFpnjWDkuaQzRKmSdAcZwsIRhj"
    static let EXPO_PUBLIC_REVENUECAT_TEST_API_KEY = "sk_JvKJFpnjWDkuaQzRKmSdAcZwsIRhj"
